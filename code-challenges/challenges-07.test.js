...
//for sorting in decending order :  numArray.sort((a, b) => b - a);
...
------------------------------------------------------------------------------------------------ */
//"at the index, replace 3 elements" splice parameters are as such: ('index number', 'optional-number of elements', 'optional-replace with value')
