...
//https://stackoverflow.com/questions/46125796/return-longest-string-in-array-javascript/46125904
/* ------------------------------------------------------------------------------------------------
CHALLENGE 1 - Review
...
const standardizePhoneNumbers = (arr) => arr.map(str => str.replace(/-|[(]|[)]| /g, ''));
